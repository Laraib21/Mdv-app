            ...
            ScrollView {
                ...
                ForEach(announcementsLoader.announcements) { announcement in
                    NavigationLink(
                        ...
                        label: {
                            AnnouncementView(announcement: announcement, maxCharacters: 30)
                                .padding()
                        })
...
struct AnnouncementView: View {
    ...
    var choppedAnnouncmentBodyText: String {
        if let charcterLimit = maxCharacters,announcement.body.count > charcterLimit{
            let endIndex = announcement.body.index(announcement.body.startIndex, offsetBy: charcterLimit)
            return String(announcement.body[announcement.body.startIndex..<endIndex]) + " ..."
        } else {
        ...
        VStack {
            VStack {
                Text(announcement.title)
                    ...
                    .padding(.vertical, 2)
                Text(choppedAnnouncmentBodyText)
